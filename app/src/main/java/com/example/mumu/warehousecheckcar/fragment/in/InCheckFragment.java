...
import static com.example.mumu.warehousecheckcar.App.IN_DETAIL_LIST;

/**
 * Created by mumu on 2018/12/9.
 */

public class InCheckFragment extends CodeFragment implements BRecyclerAdapter.OnItemClickListener {
