...
import com.example.mumu.warehousecheckcar.entity.ResultBean;
...
public class CarOutStockFragment extends BaseFragment implements UHFCallbackLiatener, OnRfidResult {
    ...
    private void downLoadData() {
        for (String no : noList) {
            ...
            try {
                OkHttpClientManager.postJsonAsyn(App.IP + ":" + App.PORT + "/shYf/sh/static/getInfoByApplyNo", new OkHttpClientManager.ResultCallback<ResultBean<CarOutBean>>() {
                    @Override
                    ...
                    @Override
                    public void onResponse(ResultBean<CarOutBean> resultBean) {
