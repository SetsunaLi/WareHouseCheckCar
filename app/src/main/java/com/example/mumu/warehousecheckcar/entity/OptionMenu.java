...
//    id是布局里面的id，value是对应MainActivity里跳转的序号
    ...
    ,ITEM9(R.id.nav_item9,8),ITEM10(R.id.nav_item10,9),ITEM11(R.id.nav_item11,10),ITEM12(R.id.nav_item12,11), ITEM13(R.id.nav_item13, 12), ITEM14(R.id.nav_item14, 13), ITEM15(R.id.nav_item15, 14), ITEM16(R.id.nav_item16, 15), ITEM17(R.id.nav_setting, 16), ITEM18(R.id.nav_item17, 17), ITEM19(R.id.nav_item18, 18), ITEM20(R.id.nav_about, 19);
    private int id;
    private int index;
