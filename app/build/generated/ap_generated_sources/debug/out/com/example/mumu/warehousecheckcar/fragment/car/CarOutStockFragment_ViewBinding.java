...
public class CarOutStockFragment_ViewBinding<T extends CarOutStockFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public CarOutStockFragment_ViewBinding(final T target, View source) {
    this.target = target;
