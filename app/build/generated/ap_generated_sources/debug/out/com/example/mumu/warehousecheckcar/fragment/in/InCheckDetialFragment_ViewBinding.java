...
public class InCheckDetialFragment_ViewBinding<T extends InCheckDetialFragment> implements Unbinder {
  protected T target;

  @UiThread
  public InCheckDetialFragment_ViewBinding(T target, View source) {
    this.target = target;
