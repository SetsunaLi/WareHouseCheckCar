...
public class CarSoldOutCarrierFragment_ViewBinding<T extends CarSoldOutCarrierFragment> implements Unbinder {
  protected T target;

  private View view2131296313;

  @UiThread
  public CarSoldOutCarrierFragment_ViewBinding(final T target, View source) {
    this.target = target;
