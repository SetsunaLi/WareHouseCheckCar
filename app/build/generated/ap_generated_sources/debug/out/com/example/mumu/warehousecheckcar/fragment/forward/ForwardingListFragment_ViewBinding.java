...
public class ForwardingListFragment_ViewBinding<T extends ForwardingListFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public ForwardingListFragment_ViewBinding(final T target, View source) {
    this.target = target;
