...
public class ReturnGoodsInFragment_ViewBinding<T extends ReturnGoodsInFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public ReturnGoodsInFragment_ViewBinding(final T target, View source) {
    this.target = target;
