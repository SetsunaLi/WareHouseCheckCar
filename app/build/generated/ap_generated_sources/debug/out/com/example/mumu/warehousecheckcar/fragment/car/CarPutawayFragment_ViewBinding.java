...
public class CarPutawayFragment_ViewBinding<T extends CarPutawayFragment> implements Unbinder {
  protected T target;

  private View view2131296313;

  @UiThread
  public CarPutawayFragment_ViewBinding(final T target, View source) {
    this.target = target;
