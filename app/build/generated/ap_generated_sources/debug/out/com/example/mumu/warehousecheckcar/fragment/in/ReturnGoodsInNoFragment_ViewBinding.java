...
public class ReturnGoodsInNoFragment_ViewBinding<T extends ReturnGoodsInNoFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public ReturnGoodsInNoFragment_ViewBinding(final T target, View source) {
    this.target = target;
