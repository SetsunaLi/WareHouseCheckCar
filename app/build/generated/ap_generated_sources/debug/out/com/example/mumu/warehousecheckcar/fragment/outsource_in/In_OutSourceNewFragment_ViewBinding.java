...
public class In_OutSourceNewFragment_ViewBinding<T extends In_OutSourceNewFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public In_OutSourceNewFragment_ViewBinding(final T target, View source) {
    this.target = target;
