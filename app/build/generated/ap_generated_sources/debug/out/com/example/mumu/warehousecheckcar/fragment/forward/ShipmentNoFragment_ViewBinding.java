...
public class ShipmentNoFragment_ViewBinding<T extends ShipmentNoFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public ShipmentNoFragment_ViewBinding(final T target, View source) {
    this.target = target;
