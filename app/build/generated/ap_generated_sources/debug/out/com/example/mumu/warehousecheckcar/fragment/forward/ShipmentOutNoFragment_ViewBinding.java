...
public class ShipmentOutNoFragment_ViewBinding<T extends ShipmentOutNoFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public ShipmentOutNoFragment_ViewBinding(final T target, View source) {
    this.target = target;
