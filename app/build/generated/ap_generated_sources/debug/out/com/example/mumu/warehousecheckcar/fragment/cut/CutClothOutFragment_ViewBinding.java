...
public class CutClothOutFragment_ViewBinding<T extends CutClothOutFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public CutClothOutFragment_ViewBinding(final T target, View source) {
    this.target = target;
