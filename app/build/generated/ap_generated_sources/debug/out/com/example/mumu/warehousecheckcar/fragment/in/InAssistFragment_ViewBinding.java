...
public class InAssistFragment_ViewBinding<T extends InAssistFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public InAssistFragment_ViewBinding(final T target, View source) {
    this.target = target;
