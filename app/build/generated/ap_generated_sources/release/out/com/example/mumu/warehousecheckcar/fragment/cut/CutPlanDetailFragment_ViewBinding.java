...
public class CutPlanDetailFragment_ViewBinding<T extends CutPlanDetailFragment> implements Unbinder {
  protected T target;

  @UiThread
  public CutPlanDetailFragment_ViewBinding(T target, View source) {
    this.target = target;
