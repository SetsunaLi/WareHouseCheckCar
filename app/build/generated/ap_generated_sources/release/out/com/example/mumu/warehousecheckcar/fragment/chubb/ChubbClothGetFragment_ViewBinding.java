...
public class ChubbClothGetFragment_ViewBinding<T extends ChubbClothGetFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public ChubbClothGetFragment_ViewBinding(final T target, View source) {
    this.target = target;
