...
public class PutawayCarrierFragment_ViewBinding<T extends PutawayCarrierFragment> implements Unbinder {
  protected T target;

  private View view2131296313;

  @UiThread
  public PutawayCarrierFragment_ViewBinding(final T target, View source) {
    this.target = target;
