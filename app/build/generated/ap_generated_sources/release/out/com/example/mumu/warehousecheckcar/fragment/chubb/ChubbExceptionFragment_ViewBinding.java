...
public class ChubbExceptionFragment_ViewBinding<T extends ChubbExceptionFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public ChubbExceptionFragment_ViewBinding(final T target, View source) {
    this.target = target;
