...
public class PutawayDetailFragment_ViewBinding<T extends PutawayDetailFragment> implements Unbinder {
  protected T target;

  @UiThread
  public PutawayDetailFragment_ViewBinding(T target, View source) {
    this.target = target;
