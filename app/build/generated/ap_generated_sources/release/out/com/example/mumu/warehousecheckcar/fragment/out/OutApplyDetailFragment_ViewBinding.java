...
public class OutApplyDetailFragment_ViewBinding<T extends OutApplyDetailFragment> implements Unbinder {
  protected T target;

  @UiThread
  public OutApplyDetailFragment_ViewBinding(T target, View source) {
    this.target = target;
