...
public class ChubbClothGetNewFragment_ViewBinding<T extends ChubbClothGetNewFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public ChubbClothGetNewFragment_ViewBinding(final T target, View source) {
    this.target = target;
