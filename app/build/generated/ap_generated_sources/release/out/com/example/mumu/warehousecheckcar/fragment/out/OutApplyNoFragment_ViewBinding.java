...
public class OutApplyNoFragment_ViewBinding<T extends OutApplyNoFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public OutApplyNoFragment_ViewBinding(final T target, View source) {
    this.target = target;
