...
public class ChubbUpCarrierFragment_ViewBinding<T extends ChubbUpCarrierFragment> implements Unbinder {
  protected T target;

  private View view2131296313;

  @UiThread
  public ChubbUpCarrierFragment_ViewBinding(final T target, View source) {
    this.target = target;
