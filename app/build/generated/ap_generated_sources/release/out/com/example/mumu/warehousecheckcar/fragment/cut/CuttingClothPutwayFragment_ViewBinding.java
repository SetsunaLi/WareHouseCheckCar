...
public class CuttingClothPutwayFragment_ViewBinding<T extends CuttingClothPutwayFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public CuttingClothPutwayFragment_ViewBinding(final T target, View source) {
    this.target = target;
