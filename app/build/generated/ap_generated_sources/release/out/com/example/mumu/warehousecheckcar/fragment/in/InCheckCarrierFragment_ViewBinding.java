...
public class InCheckCarrierFragment_ViewBinding<T extends InCheckCarrierFragment> implements Unbinder {
  protected T target;

  private View view2131296313;

  @UiThread
  public InCheckCarrierFragment_ViewBinding(final T target, View source) {
    this.target = target;
