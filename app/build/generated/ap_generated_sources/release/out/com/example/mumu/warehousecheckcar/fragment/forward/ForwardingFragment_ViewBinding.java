...
public class ForwardingFragment_ViewBinding<T extends ForwardingFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public ForwardingFragment_ViewBinding(final T target, View source) {
    this.target = target;
