...
public class In_OutSourceNoFragment_ViewBinding<T extends In_OutSourceNoFragment> implements Unbinder {
  protected T target;
  ...
  @UiThread
  public In_OutSourceNoFragment_ViewBinding(final T target, View source) {
    this.target = target;
