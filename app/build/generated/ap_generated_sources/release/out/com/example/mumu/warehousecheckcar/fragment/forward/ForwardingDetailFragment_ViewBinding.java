...
public class ForwardingDetailFragment_ViewBinding<T extends ForwardingDetailFragment> implements Unbinder {
  protected T target;

  @UiThread
  public ForwardingDetailFragment_ViewBinding(T target, View source) {
    this.target = target;
